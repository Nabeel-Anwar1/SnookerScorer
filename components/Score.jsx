...
<View >
   ...
   <ModalScore        
    ...
    <Pressable style={styles.button1} onPress={()=>{setModalVisible(true); setPlayer(1)}}>
    ...
    <Pressable style={styles.button2} onPress={()=>{setModalVisible(true); setPlayer(2)}}>
        <Text style={styles.score2}>{score2}</Text>
        <Text style={styles.frames2}>Frames: {frame2}</Text>
    </Pressable>
    </View>
    <View style={styles.b3}>
    <Pressable style={styles.reset} onPress={()=>{setFrame1(0); setFrame2(0); setScore1(0); setScore2(0)}}>
